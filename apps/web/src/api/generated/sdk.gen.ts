 ...
 */
export const loadTestsDuplicate = <ThrowOnError extends boolean = false>(options: Options<LoadTestsDuplicateData, ThrowOnError>) => (options.client ?? client).post<LoadTestsDuplicateResponses, LoadTestsDuplicateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
